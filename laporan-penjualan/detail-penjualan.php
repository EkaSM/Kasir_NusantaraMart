...
$total= getData("SELECT * FROM tbl_jual_head WHERE no_jual = '$id'");
                    ...
                    <table class="table table-hover text-nowrap">
                            ...
                            foreach ($penjualan as $jual) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?=  number_format($jual['harga_jual'],0,",", ".") ?>
                                    </td>
                                    <td class="text-center"><?=  $jual['qty'] ?></td>
                                    <td class="text-center">
                                        <?=  number_format($jual['jml_harga'],0,",", ".") ?>
                                    </td>
                                </tr>
                                <?php
                            }
                        ...
                        <?php
                            ...
                            foreach ($total as $tot) { ?>
                                <tr>
                                    <td colspan="2" class="text-center" align="right"><strong>Total Keseluruhan </strong></td>
                                    <td colspan="3" class="text-center" align="right"><strong> : </strong></td>
                                    <td class="text-center" align="right"><strong><?=  number_format($tot['total'],0,",", ".") ?> </strong></td>
                                </tr>
                                <?php
                            }
                            ?>
