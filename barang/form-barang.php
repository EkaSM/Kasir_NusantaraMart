...
$title = "Form Barang - NusantaraMart";
                    ...
                    <div class="row">
                        <div class="col-lg-8 mb-3 pr-3">
                            <div class="form-group">
                                ...
                                id="kode" value="<?= $msg != '' ? $barang['id_barang'] : generateId()?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="barcode">Barcode*</label>
                                <input type="text" name="barcode" class="form-control" 
                                id="barcode" value="<?= $msg != '' ? $barang['barcode'] : null?>"placeholder="Barcode" autocomplete="off"
                                autofocus required>
                            </div>
                            <div class="form-group">
                                <label for="name">Nama Barang*</label>
                                <input type="text" name="name" class="form-control" 
                                id="name" placeholder="Nama Barang" value="<?= $msg != '' ? $barang['nama_barang'] : null?>" 
                                autocomplete="off"
                                autofocus required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                id="harga_beli" value="<?= $msg != '' ? $barang['harga_beli'] : null?>"
                            ...
                            <div class="form-group">
                                ...
                                id="harga_jual" value="<?= $msg != '' ? $barang['harga_jual'] : null?>"
                                placeholder="Rp 0" autocomplete="off"
                                required>
                            </div>
                            <!-- <div class="form-group">
                                ...
                                id="stock" value="<?= $msg != '' ? $barang['stock'] : null?>"
                            ...
                            <div class="form-group">
                                ...
                                id="stock_minimal" value="<?= $msg != '' ? $barang['stock_minimal'] : null?>"
                                placeholder="0" autocomplete="off"
                                required>
                            </div>
                        </div>
                        <div class="col-lg-4 text-center px-3">
                            ...
                            <img src="<?= $main_url ?>asset/image/<?= $msg != '' ? $barang['gambar'] : 'brg.png'?>" 
                            class="profile-user-img mb-3 mt-4"alt="">
                            <input type="file" class="form-control" name="image">
                            <span class="text-sm">Type file JPG / PNG</span>
                        </div>
                    </div>
                </div>
                </form>
