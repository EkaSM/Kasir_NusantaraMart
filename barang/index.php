...
require "../module/mode-barang2.php";

$title = "Data Barang - NusantaraMart";
...
$alert = '';
// Fungsi hapus barang dilaksanakan
if ($msg == 'deleted') {
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="<?=$main_url ?>barang/form-barang.php" 
                    class="mr-2 btn-sm btn-primary float-right"><i class="fas fa-plus fa-sm"></i> Add Barang</a>
                </div>
                            ...
                            foreach ($barang as $brg) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        id="btnCetakBarcode" data-barcode="<?= $brg['barcode']?>"
                                        data-nama="<?= $brg['nama_barang']?>" title="cetak barcode">
                                        <i class="fas fa-barcode"></i></button>
                                        <a href="form-barang.php?id=<?= $brg['id_barang'] 
                                        ?>&msg=editing" class="btn btn-warning 
                                        btn-sm" title="edit barang">
                                        <i class="fas fa-pen"></i></a>
                                        <a href="?id=<?= $brg['id_barang'] ?>&gbr=<?= $brg
                                        ['gambar'] ?>&msg=deleted" class="btn btn-danger 
                                        btn-sm" title="hapus barang" onclick="return confirm('Anda yakin akan menghapus barang ini ?')">
        ...
        $(document).ready(function(){
            ...
            $(document).on("click", "#preview", function() {
                ...
                if (jmlCetak > 0 && jmlCetak <= 10) {
                    window.open("../report/r-barcode.php?barcode=" 
                    + barcode + "&jmlCetak=" + jmlCetak)
                }
            })
        });
      </script>
