...
$title = "Edit Customer - NusantaraMart";
                ...
                <div class="card-body">
                    ...
                    <div class="col-lg-8 mb-3">
                        <div class="form-group">
                            ...
                            placeholder="Nama customer" autofocus 
                            value="<?= $customer['nama']?>"required>
                        </div>
                        <div class="form-group">
                            <label for="telpon">Telpon</label>
                            <input type="text" name="telpon" class="form-control" id="telpon"
                            placeholder="Nomer telpon customer" pattern="[0-9]{5,}" 
                            title="minimal 5 angka" 
                            value="<?= $customer['telpon']?>"required>
                        </div>
                        <div class="form-group">
                            <label for="ketr">Deskripsi</label>
                            <textarea name="ketr" id="ketr" rows="1" 
                            class="form-control" placeholder="Keterangan customer" required>
                            <?= $customer['deskripsi']?></textarea>
                        </div>
                        <div class="form-group">
