...
$title = "Add Customer - NusantaraMart";
                ...
                <div class="card-body">
                    ...
                    <div class="col-lg-8 mb-3">
                        ...
                        <div class="form-group">
                            ...
                            class="form-control" placeholder="Keterangan customer" required></textarea>
                        </div>
                        <div class="form-group">
                            <label for="alamat">Alamat</label>
                            <textarea name="alamat" id="alamat" rows="3" 
                            class="form-control" placeholder="Alamat customer" required></textarea>
                        </div>
                    </div>
                    </div>
                </div>
