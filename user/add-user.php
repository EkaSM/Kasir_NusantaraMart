...
if (isset($_POST['simpan'])) {
    if (insert($_POST) > 0) {
        echo "<script>alert('User baru berhasil ditambahkan.....');document.location.href = 'data-user.php'
        </script>";
    }
}
?>
                    ...
                    <div class="row">
                        <div class="col-lg-8 mb-3">
                            ...
                            <div class="form-group">
                                ...
                                id="password2" placeholder="Masukkan Kembali Password" required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-lg-4 text-center">
                                <img src="<?= $main_url ?>asset/image/user.png" class="profile-user-img-circle mb-3"
                                alt="">
