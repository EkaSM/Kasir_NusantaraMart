...
<head>
  ...
  <title>Login - NusantaraMart</title>
  ...
  <link rel="shortcut icon" href="<?=$main_url ?>asset/image/icon.png" type="image/x-icon">
...
<div class="login-box slide-down" style="margin-top : -70px;">
  ...
  <div class="card card-outline card-success">
    <div class="card-header text-center">
      <a href="#" class="h1"><b>Nusantara</b> Mart</a>
    </div>
    <div class="card-body">
      ...
      <p class="my-3 text-center">
        <strong>Copyright &copy; 2024 <span class="text-info">Nusantara Mart</span> </strong>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
