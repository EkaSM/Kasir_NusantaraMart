...
$nota = $_GET['nota'];
$dataJual = getData("SELECT * FROM tbl_jual_head WHERE 
no_jual = '$nota'")[0];
$itemJual = getData("SELECT * FROM tbl_jual_detail WHERE 
no_jual = '$nota'");
?>
...
<body>
    ...
    font-size : 14x; width : 240px;">
        <tr>
            <td><b>NusantaraMart</b></td>
        </tr>
        <tr>
            <td><?= 'No Nota : ' . $nota ?></td>
        </tr>
    ...
    <table style="border-bottom : dotted 2px; font-size : 14x; width : 240px;">
        <?php
    ...
    <table style="border-bottom : solid 2px; font-size : 14x; width : 240px;">
        <tr>
            <td colspan="3" style="width : 100px;"></td>
    ...
    <table style="text-align : center; margin-top: 5px; font-size : 14x; width : 240px;">
        <tr>
            <td>Terima Kasih telah berbelanja</td>
        </tr>
        <tr>
